    ...
    <View style={styles.card}>
      ...
      <View style={styles.cardContent}>
        ...
        <View style={[styles.slotsBadge, { backgroundColor: item.slotsColor }]}>
          <Text style={[styles.slotsText, { color: item.slotsTextColor }]}>
            {item.slots}
          </Text>
        </View>
        ...
        <ScreenWrapper style={{ flex: 1 }} backgroundColor="#f9f9f9">
          ...
          >
            ...
            <View style={styles.timePickerContainer}>
              ...
              >
                Your service will take approximately 58 minutes
              </Text>
            ...
            {modalStep === "details" ? (
              <>
                ...
                <Text style={styles.modalSubtitle}>
                  Enter your details to confirm your wash.
                </Text>
              ...
              <>
                ...
                >
                  <Text style={{ color: "#888", marginRight: 5 }}>
                    Didn't receive code?
                  </Text>
                  <TouchableOpacity>
